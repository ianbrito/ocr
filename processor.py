...
class Processor:
    ...
    def execute(self, file_path, handwritten=False):
        ...
        if ext in [".jpg", ".jpeg", ".png", ".tiff"]:
            text = self.extract_text_from_image(file_path, handwritten=handwritten)
        elif ext == ".pdf":
            text = self.extract_text_from_pdf(file_path, handwritten=handwritten)
        else:
        ...
        json_data = self.__extrator.extract(document_data["extracted_text"])

        document_data["metadata"] = json_data
